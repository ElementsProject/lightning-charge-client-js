...
var LightningChargeClient = function () {
  function LightningChargeClient(url, token) {
    _classCallCheck(this, LightningChargeClient);

    this.url = token == null ? url : (0, _url.format)(_extends({}, (0, _url.parse)(url), { auth: 'api-token:' + token }));
    this.req = (0, _superagentBaseuri2.default)(this.url.replace(/\/$/, ''));
  }
